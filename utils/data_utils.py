...
def get_loader(args):
    ...
    if args.dataset == 'dogs':
        ...
        trainset = CUB(args.dataset, root=args.data_root, is_train=True, \
            transform=train_transform, sm_vit=args.isU2net, img_size=args.img_size)
        testset = CUB(args.dataset, root=args.data_root, is_train=False, \
            transform = test_transform, sm_vit=args.isU2net, img_size=args.img_size)
    ...
    if args.dataset == 'INat2017':
        ...
        train_transform=transforms.Compose([transforms.Resize((args.img_size, args.img_size),Image.BILINEAR),
                                    transforms.RandomCrop((args.img_size, args.img_size)),
